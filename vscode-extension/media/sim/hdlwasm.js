...
const binaryen_1 = require("binaryen");
...
function getBinaryenType(size) {
    if (size <= 4)
        ...
        return binaryen_1.default.i64;
    else
        return binaryen_1.default.none;
}
class Struct {
    constructor() {
        this.len = 0;
...
class HDLModuleWASM {
    ...
    cacheFunctions() {
        ...
        this._tick2 = this.instance.exports.tick2;
    }
    powercycle() {
    ...
    //
    genMemory() {
        this.bmod = new binaryen_1.default.Module();
        this.bmod.setFeatures(binaryen_1.default.Features.SignExt);
        this.genTypes();
    ...
    genTypes() {
        ...
        state.addEntry(TRACERECLEN, 4, binaryen_1.default.i32);
        state.addEntry(TRACEOFS, 4, binaryen_1.default.i32);
        state.addEntry(TRACEEND, 4, binaryen_1.default.i32);
    ...
    genFunction(block) {
        ...
        fscope.addEntry(GLOBAL, 4, binaryen_1.default.i32, null, true); // 1st param to function
        // add __req local if change_request function
        if (this.funcResult(block.name) == binaryen_1.default.i32) {
            fscope.addEntry(CHANGEDET, 1, binaryen_1.default.i32, null, false);
        }
        ...
        var fsig = binaryen_1.default.createType([binaryen_1.default.i32]); // pass dataptr()
    ...
    addImportedFunctions() {
        this.bmod.addFunctionImport('$finish_0', 'builtins', '$finish', binaryen_1.default.createType([binaryen_1.default.i32]), binaryen_1.default.none);
        this.bmod.addFunctionImport('$stop_0', 'builtins', '$stop', binaryen_1.default.createType([binaryen_1.default.i32]), binaryen_1.default.none);
        this.bmod.addFunctionImport('$time_0', 'builtins', '$time', binaryen_1.default.createType([binaryen_1.default.i32]), binaryen_1.default.i64);
        this.bmod.addFunctionImport('$rand_0', 'builtins', '$rand', binaryen_1.default.createType([binaryen_1.default.i32]), binaryen_1.default.i32);
        this.bmod.addFunctionImport('$readmem_2', 'builtins', '$readmem', binaryen_1.default.createType([binaryen_1.default.i32, binaryen_1.default.i32, binaryen_1.default.i32]), binaryen_1.default.none);
    }
    getImportObject() {
        var n = 0;
        return {
    ...
    addCopyTraceRecFunction() {
        ...
        var i32 = binaryen_1.default.i32;
        var none = binaryen_1.default.none;
        var l_block = this.label('@block');
        var l_loop = this.label('@loop');
        m.addFunction('copyTraceRec', binaryen_1.default.createType([]), none, [i32, i32, i32], // src, len, dest
        m.block(l_block, [
    ...
    addTick2Function() {
        ...
        if (this.globals.lookup('clk')) {
            var v_dseg = m.local.get(0, binaryen_1.default.i32);
            //var v_count = m.local.get(1, binaryen.i32);
            m.addFunction('tick2', binaryen_1.default.createType([binaryen_1.default.i32, binaryen_1.default.i32]), binaryen_1.default.none, [], m.loop(l_loop, m.block(null, [
                this.makeSetVariableFunction('clk', 0),
                m.drop(m.call('eval', [v_dseg], binaryen_1.default.i32)),
                this.makeSetVariableFunction('clk', 1),
                m.drop(m.call('eval', [v_dseg], binaryen_1.default.i32)),
                // call copyTraceRec
                m.call('copyTraceRec', [], binaryen_1.default.none),
                // goto @loop if ($1 = $1 - 1)
                m.br_if(l_loop, m.local.tee(1, m.i32.sub(m.local.get(1, binaryen_1.default.i32), m.i32.const(1)), binaryen_1.default.i32)),
            ])));
    ...
    addEvalFunction() {
        this.bmod.addFunction('eval', binaryen_1.default.createType([binaryen_1.default.i32]), binaryen_1.default.i32, [], this.makeTickFuncBody(0));
    ...
    makeTickFuncBody(count) {
        var dseg = this.bmod.local.get(0, binaryen_1.default.i32);
        if (count > this.maxEvalIterations)
            return this.bmod.i32.const(count);
        return this.bmod.block(null, [
            this.bmod.call('_eval', [dseg], binaryen_1.default.none),
            this.bmod.if(this.bmod.call('_change_request', [dseg], binaryen_1.default.i32), this.makeTickFuncBody(count + 1), this.bmod.return(this.bmod.local.get(0, binaryen_1.default.i32))),
        ], binaryen_1.default.i32);
    }
    funcResult(funcname) {
    ...
    i3264(dt) {
        ...
        if (type == binaryen_1.default.i32)
            return this.bmod.i32;
        else if (type == binaryen_1.default.i64)
    ...
    dataptr() {
        return this.bmod.local.get(0, binaryen_1.default.i32); // 1st param of function == data ptr
    }
    e2w(e, opts) {
        if (e == null) {
    ...
    block2wasm(e, opts) {
        ...
        var ret = opts && opts.funcblock ? this.funcResult(opts.funcblock.name) : binaryen_1.default.none;
        // must have return value for change_request function
        if (ret == binaryen_1.default.i32) {
    ...
    _while2wasm(e, opts) {
        ...
        if (e.loopcond) {
            ...
            block.push(this.bmod.if(this.e2w(e.loopcond, { resulttype: binaryen_1.default.i32 }), this.bmod.nop(), this.bmod.br(l_block)));
        }
        if (e.body) {
        ...
        return this.bmod.loop(l_loop, this.bmod.block(l_block, block, binaryen_1.default.none));
    }
    _ccast2wasm(e, opts) {
    ...
    _extends2wasm(e, opts) {
        var value = this.e2w(e.left);
        var inst = this.i3264(e.dtype);
        if (this.bmod.getFeatures() & binaryen_1.default.Features.SignExt) {
            if (e.widthminv == 8) {
