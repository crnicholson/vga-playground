...
class VGASimulatorPanel {
    ...
    simulateVerilogCode(code, fileName) {
    ...
    _getHtmlForWebview(webview) {
        ...
        const hdlLoaderUri = webview.asWebviewUri(vscode.Uri.joinPath(this._extensionUri, 'media', 'hdlLoader.js'));
...
<body>
    ...
    <script nonce="${nonce}" src="${hdlLoaderUri}"></script>
