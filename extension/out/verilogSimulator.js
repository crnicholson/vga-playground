...
exports.VerilogSimulator = void 0;
const verilogExpressionEvaluator_1 = require("./verilogExpressionEvaluator");
class VerilogSimulator {
    constructor() {
        this.clockRate = 25000000; // 25MHz clock
        this.frameTime = 1 / 60; // 60Hz refresh rate
        this.state = {
            clock: 0,
            frame: 0,
            h_count: 0,
        ...
        this.alwaysBlocks = [];
        this.evaluator = new verilogExpressionEvaluator_1.VerilogExpressionEvaluator(this.signals, this.state);
    }
    compile(verilogContent) {
        try {
    ...
    shouldTriggerAlwaysBlock(sensitivity) {
...
exports.VerilogSimulator = VerilogSimulator;
//# sourceMappingURL=verilogSimulator.js.map